...
using Content.Shared.Roles;  // Orion: sorting by departments
...
public sealed partial class CrewMonitoringWindow : FancyWindow
{
    ...
    public void ShowSensors(List<SuitSensorStatus> sensors, EntityUid monitor, EntityCoordinates? monitorCoords)
    {
        ...
        var departments = uniqueSensors
            ...
            .Distinct()
            .Where(id => _prototypeManager.HasIndex<DepartmentPrototype>(id))
        ...
        foreach (var department in departments)
        {
            ...
            // Orion-Edit-Start: sorting by departments
            var departmentProto = _prototypeManager.Index<DepartmentPrototype>(department);
            deparmentLabel.SetMessage(Loc.GetString(departmentProto.Name));
            // Orion-Edit-End
