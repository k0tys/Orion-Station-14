...
public sealed class DeepMaintenanceUiFragment : BoxContainer
{
    ...
    private sealed class DeepMaintenanceGameControl : Control
    {
        ...
        private sealed class ProjectileData
        {
            ...
            public ProjectileData(Vector2 position, Vector2 sourcePosition, Vector2 velocity, float radius, int damage, float lifetime, string spritePath, string spriteState)
            {
                Position = position;
                PreviousPosition = position;
