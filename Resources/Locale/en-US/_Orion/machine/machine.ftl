...
machine-upgrade-stasis-bed-power = stasis power draw
...
machine-upgrade-hydro-nutrition = nutrient capacity
machine-upgrade-hydro-nutrition-consume = nutrient use
