...
ntr-executive-disk-small-desc = Получите небольшой исследовательский грант от ведущей исследовательской команды НаноТрейзен, содержащий 10 дисков с исследовательскими очками.
...
ntr-executive-mats-desc = Закажите строительные материалы из глобального отдела снабжения НаноТрейзен.
...
ntr-executive-pizza-small-desc = Закажите набор для небольшой вечеринки от НаноТрейзен. Как хороший сотрудник, вы ведь поделитесь пиццей с коллегами... или съедите всё сами?
...
ntr-executive-softsuit-name = Заказать базовый ЕВА
ntr-executive-softsuit-desc = Базовый ЕВА, предназначенный для кратковременного пребывания в космосе. Обеспечивает минимальную защиту.
ntr-executive-hardsuit-name = Заказать ЕВА
ntr-executive-hardsuit-desc = Прочный ЕВА для экстремальных условий. Вы уверены, что эта покупка оправдана?
ntr-experimental-hardsuit-name = Заказать скафандр
ntr-experimental-hardsuit-desc = НаноТрейзен тестирует экспериментальный экокостюм, собранный из блюспейс-проводящих пластин, созданный путём обратной инженерии скафандра Дредноут от Киберсан’s, с проведением реальных испытаний под вашим наблюдением.
...
ntr-executive-savaliniaharunianisimious-desc = Стандартный лазерный пистолет Свалинн, часто используемый в программах самообороны НаноТрейзен.
...
ntr-executive-teleporter-desc = Плата грузового телепада, упрощающего транспортировку ресурсов. Несанкционированное использование считается кражей по политике НаноТрейзен.
