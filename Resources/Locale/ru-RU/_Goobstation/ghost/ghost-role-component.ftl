...
ghost-role-information-special-operations-officer-description = Отправляйте, инструктируйте и управляйте отрядами быстрого реагирования и другими силами НаноТрейзен.
ghost-role-information-special-operations-officer-rules = Доставьте представителя НаноТрейзен живым, остальные — цифра в статистике. Приказы [color=#yellow][bold]Капитана ВМС[/bold][/color] могут изменить это.
...
ghost-role-information-Gman-rules = Вы не подчиняешься никаким правилам или ограничениям. Смерть не властна над вами, как и НаноТрейзен.

# Blueshild Deputy

ghost-role-information-bsd-name = Представитель Синего Щита
ghost-role-information-bsd-description = Вас вызвал на станцию Представитель НаноТрейзен. Подчиняйтесь ему, защищайте командование, следуйте Корпоративному Закону.
ghost-role-information-bsd-rules = Следуйте приказам, данными вам [color=yellow][bold]Представителем НаноТрейзен[/bold][/color], защищайте командование.
# interns
