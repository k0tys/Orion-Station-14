...
job-description-mercenarycaptain = Отдавайте приказы другим наёмникам. Служите мышцами самому щедрому заказчику. То, что сейчас это НаноТрейзен, не значит, что позже это не изменится.

# Viro
job-description-virologist = Изучайте распространяющиеся вирусы, разрабатывайте лекарства для больных членов экипажа, экспериментируйте с созданием полезных вирусов. Следите за тем, чтобы пандемии не распространялись.
