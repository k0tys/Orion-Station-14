...
server-currency-name-singular = §
server-currency-name-plural = §
...
gs-balanceui-shop-label = Управление токенами
gs-balanceui-shop-empty = Нет в наличии!
gs-balanceui-shop-buy = Купить
gs-balanceui-shop-footer = ⚠ Токены можно использовать из инвентаря в любой момент.
gs-balanceui-shop-token-label = Магазин токенов
gs-balanceui-shop-tittle-label = Титулы
gs-balanceui-shop-buy-token-antag = Купить токен антага - { $price }§
gs-balanceui-shop-buy-token-admin-abuse = Купить токен на админарбуз - { $price }§
gs-balanceui-shop-buy-token-hat = Купить токен на шляпу - { $price }§
gs-balanceui-shop-token-antag = Токен антагониста
