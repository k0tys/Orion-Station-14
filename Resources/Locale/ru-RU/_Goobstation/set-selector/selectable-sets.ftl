...
selectable-set-thief-syndie-description =
    ...
    Включает: криптографический секвенсор, разрушитель аутентификации, сигареты Интердайн, кодовое слово синдиката,
    глушитель связи, коробку зажигалок и ТК.
...
selectable-set-ert-ballistic-description =
    ...
    Содержит: винтовку Энни калибра 5.45мм,
