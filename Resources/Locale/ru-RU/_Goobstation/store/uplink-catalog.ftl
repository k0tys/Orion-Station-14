...
uplink-hardlight-bow-desc = Этот складной лук может создавать множество типов стрел в зависимости от потребностей пользователя.
...
uplink-weapon-heavy-shotgun-desc = Портативное оружие, нарушающее права человека. Взрывоопасен и при выстреле буквально отбросит вас назад на шесть футов. Заряжается из барабанных магазинов 2-го калибра.
uplink-WSPR-name = WSPR
uplink-WSPR-desc = Бесшумная, дозвуковая и безгильзовая винтовка для оперативников, не оставляющая следов. Более эффективна против небронированных целей. Имеет патронник на пули 9.5мм.
uplink-c20r-name = C-20R
uplink-c20r-desc = Пистолет-пулемет, предназначенный для стрельбы одной рукой, который жертвует точностью ради высокой скорости стрельбы. Заряжается из 2.5мм пулями.
uplink-buldog-name = Бульдог
uplink-buldog-desc = Полностью автоматический дробовик, для тех случаев, когда у вас есть три секунды, чтобы превратить восемь человек в соус для пасты.
uplink-l6-saw-name = L6 SAW
uplink-l6-saw-desc = Громоздкий ручной пулемет, превосходный для ведения прицельного огня на подавление. Питание от 5.45мм винтовочных коробчатых магазинов.
uplink-m90-name = M-90
uplink-m90-desc = Надёжная штурмовая винтовка, сохраняющая точность даже на экстремальных дистанциях. Использует винтовочные магазины на 5.56мм.
uplink-estoc-name = Эсток
uplink-estoc-desc = Стрелковая винтовка, предназначенная для стрельбы очередями и оснащенная дорогой тритиевой оптикой. Стреляет из 5.56мм винтовочных магазинов.
uplink-syndicate-disabler-name = Станнер Синдиката
uplink-syndicate-disabler-desc = Изящный станнер, созданный на основе прототипа НаноТрейзен с обратной инженерией. Хотя ему не хватает убойной силы, он компенсирует это за счет самозаряжающегося элемента питания.
...
uplink-anaconda-desc = Громоздкое ручное орудие со встроенным в рукоятку устройством для изготовления боеприпасов. Со временем оно само печатает боеприпасы.
uplink-bulk-mosin-name = Синдикатский ящик с винтовками
uplink-bulk-mosin-desc = 10 винтовок эпохи четвёртой мировой войны для вас, друзей и вашей кошки. Экономьте 40% при оптовой покупке!
uplink-whimsy-bundle-name = Комплект радости и веселья Синдиката
uplink-whimsy-bundle-desc = Любишь радость и веселье? Донк Ко. есть, что тебе предложить! В комплекте ЛИМИТИРОВАННЫЙ топор-леденец и столько сладостей, что убьют человека.
uplink-m7s-name = M7S "Вентилятор"
uplink-m7s-desc = Дальность стрельбы из этого пистолета-пулемета увеличивается по мере того, как вы продолжаете подавлять им своих противников. Выстрелы также подавляются. Питание осуществляется из магазинов 5х23 мм с боковым заряжанием.
uplink-combat-shotgun-name = "Боевик"
uplink-combat-shotgun-desc = Помповое ружье, когда вам нужно поразить цели, находящиеся за двумя стальными стенами, холодильником и дверью автомобиля. Заряжается 5 патронами 8-го калибра.
...
uplink-pistol-magazine-caseless-saphe-desc = 10 патронов 9.5мм без гильз, с чуть большим бронепробитием и эффектом взрыва. Для пистолета Кобра.
uplink-l6-box-name = Коробка ружейных патронов (5.45мм винтовочный)
uplink-l6-box-desc = 100 патронов для пулемёта L6 SAW.
uplink-shotgun-magazine-name = Барабан для дробовика (.50 дробь)
uplink-shotgun-magazine-desc = Барабанный магазин с 8 патронами с дробью внутри. Совместим с Бульдогом и Зауэром.
uplink-shotgun-magazine-slug-name = Барабан (.50 пуля)
uplink-shotgun-magazine-slug-desc = Барабанный магазин с 8 патронами с пулями внутри. Совместим с Бульдогом и Зауэром.
...
uplink-highcap-pistol-mag-name = Магазин для пистолета повышенной ёмкости (9мм авто)
...
uplink-second-skin-desc =
    Улучшенная версия устройства НаноТрейзен службы безопасности, которая не вызывает отвращения и не разъедает материалы роботов.
...
uplink-guerrilla-gloves-desc = Специальные ударопрочные перчатки, которые делают ваши захваты крепкими, уменьшают замедление при активном захвате и усложняют жертвам возможность вырваться. Защищают от электрических разрядов.
