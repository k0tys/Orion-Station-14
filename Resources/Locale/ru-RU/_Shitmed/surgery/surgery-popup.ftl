...
surgery-popup-step-SurgeryStepSealBones = { $user } запечатывает кости на { $part } у { $target }.
surgery-popup-step-SurgeryStepSealSkull = { $user } запечатывает череп на { $part } у { $target }.
surgery-popup-step-SurgeryStepSealRibcage = { $user} восстанавливает грудную клетку на { $part } у { $target }.
