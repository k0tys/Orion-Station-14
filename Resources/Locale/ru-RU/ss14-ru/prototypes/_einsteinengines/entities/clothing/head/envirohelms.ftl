...
ent-ClothingHeadEnvirohelmAncientVoid = NTSRA экошлем
    .desc = Из модифицированного костюма NTSRA, первый экошлем для плазмалюдей, разработанный НаноТрейзен.
...
ent-ClothingHeadEnvirohelmNanotrasenRepresentative = экошлем представителя НаноТрейзен
    .desc = Чёрный экошлем для представителя НаноТрейзен с чёрными и золотыми акцентами.
...
ent-ClothingHeadEnvirohelmEnviroslacksMNK = экошлем MНК
    .desc = Элегантный экошлем от MНК. Классика!
ent-ClothingHeadEnvirohelmEnviroslacksMNKAlt = монохромный экошлем
    .desc = Элегантный экошлем от MНК. Нуар!
    .suffix = Альтернативный
