...
ent-ClothingUniformEnvirosuitDetective = экокостюм детектива
    .desc = Проект для особенно изысканного плазмалюда, модифицированный НаноТрейзен для детективов.
...
ent-ClothingUniformEnvirosuitAncientVoid = NTSRA экокостюм
    .desc = Переделанный костюм NTSRA, этот неприспособленный для космоса костюм был первым экокостюмом НаноТрейзен для плазмалюдов.
...
ent-ClothingUniformEnvirosuitNanotrasenRepresentative = экокостюм представителя НаноТрейзен
