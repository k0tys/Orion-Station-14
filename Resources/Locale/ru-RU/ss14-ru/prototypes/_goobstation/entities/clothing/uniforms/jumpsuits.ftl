...
ent-ClothingUniformJumpsuitNanotrasenRepresentative = костюм представителя НаноТрейзен
    .desc = Чёрный костюм, который носят официальные лица.
ent-ClothingUniformJumpsuitNanotrasenRepresentativeFancy = изысканный костюм представителя НаноТрейзен
...
ent-ClothingCostumeAbductor = костюм пришельца
    .desc = На ярлыке написано: Донк Ко. не несет ответственности за инциденты с применением оружия, вызванные этим изделием.
ent-ClothingUniformJumpsuitTrainer = комбинезон наставника
    .desc = Комбинезон, выданный тренерам НаноТрейзен. Наполняет чувством гордости.
