...
ent-ExecutiveIDCard = карта доступа руководителя
    .desc = Сотрудники НаноТрейзен, по закону, обязаны прослушивать сообщения пользователей при помощи одного из этих устройств. Кроме того, программа способна переопределять блокировки доступа на большинстве устройств.
