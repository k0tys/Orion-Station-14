...
ent-ClothingHeadHatSecurityTrooper = шляпа патрульного
    .desc = Широкополая шляпа Патрульных НаноТрейзен, идёт в комплекте с чехлом, но вы его потеряли.
...
ent-ClothingHeadHatBeretCommand = берет командования
    .desc = Берет с логотипом НаноТрейзен. От него исходит аура власти.
